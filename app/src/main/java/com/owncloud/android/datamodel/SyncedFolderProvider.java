...
public class SyncedFolderProvider extends Observable {
    ...
    private SyncedFolder createSyncedFolderFromCursor(Cursor cursor) {
        ...
        if (cursor != null) {
            ...
            boolean renameDuringUpload = cursor.getInt(cursor.getColumnIndexOrThrow(
                ProviderMeta.ProviderTableMeta.SYNCED_FOLDER_RENAME_DURING_UPLOAD)) == 1;
    ...
    private ContentValues createContentValuesFromSyncedFolder(SyncedFolder syncedFolder) {
        ...
        cv.put(ProviderMeta.ProviderTableMeta.SYNCED_FOLDER_RENAME_DURING_UPLOAD, syncedFolder.isRenameDuringUpload());
